...
namespace ECommerce.Application.Services.Cart
{
    public class ShoppingCartService : IShoppingCartService
    {
        ...
        public async Task<ShoppingCartDto> AddItemAsync(string userId, AddToCartDto dto)
        {
            if (string.IsNullOrWhiteSpace(userId))
                throw new ArgumentException("UserId is required", nameof(userId));
        ...
        public async Task<ShoppingCartDto> UpdateItemAsync(string userId, UpdateCartItemDto dto)
        {
            if (string.IsNullOrWhiteSpace(userId))
                throw new ArgumentException("UserId is required", nameof(userId));
        ...
        public async Task<ShoppingCartDto> RemoveItemAsync(string userId, int cartItemId)
        {
            if (string.IsNullOrWhiteSpace(userId))
                throw new ArgumentException("UserId is required", nameof(userId));
